...
function SideNavMobile() {
    ...
    return (
        <div className='side-nav2'>
            <div className='side-nav-categories'><div className='tops'>TOPS<img className = 'down-arrow' style={{transform: `${topsArrow}`}} onClick={() =>  toggleTopsAccordion() } src='https://upload.wikimedia.org/wikipedia/commons/9/9d/Arrow-down.svg'/></div>
